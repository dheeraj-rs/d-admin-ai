    ...
    return (
        <div className="flex flex-col gap-8 w-full">
            <div className="flex flex-col gap-2 items-end">
                <div className="bg-[#2f2f2f] px-5 py-2.5 rounded-3xl max-w-[80%] text-[15px] text-gray-100 self-end break-words">
                    hi
                </div>
            </div>
            <div className="flex gap-4">
                <div className="w-8 h-8 rounded-full border border-gray-600 flex-shrink-0 flex items-center justify-center bg-white text-black">
                    <SquareTerminal size={14} />
                </div>
                <div className="flex flex-col gap-2 flex-1 min-w-0 pt-1">
                    <div className="text-gray-200 leading-relaxed text-[15px] break-words">
                        Hey! 👋
                        <br />
                        <br />
                ...
                <>
                    ...
                    <div className="flex gap-4">
                        ...
                        <div className="flex flex-col gap-2 flex-1 min-w-0 pt-1">
                            ...
                            <div className="mt-4 bg-[#1e1e1e] rounded-xl overflow-hidden border border-[#2f2f2f] flex flex-col min-w-0 w-full">
                                <div className="flex justify-between items-center px-4 py-2 bg-[#2f2f2f] text-xs font-semibold text-gray-400">
                                    <div className="flex items-center gap-1.5 text-gray-300">
                                        <Code size={14} /> <span>HTML</span>
                                    </div>
                                    <div className="flex gap-2 text-gray-400 shrink-0">
                                        <button className="p-1 hover:text-white transition-colors" title="Download">
                                            <Download size={14} />
                                        </button>
                                        <button
                                            onClick={() => {
                                ...
                                <div
                                    className="px-4 py-3 text-sm font-mono text-gray-300 overflow-x-auto whitespace-pre cursor-pointer w-full"
                                    onClick={() => {
                                        setViewState('fullscreen-editor');
                                        setActiveTab('code');
                                    }}
