...
export default function Sidebar({
    ...
    return (
        <>
            <div
                className={`bg-cyan-100/70 dark:bg-[#02060D]/60 backdrop-blur-3xl border-r border-cyan-200/50 dark:border-white/5 h-full transition-all duration-300 ease-in-out relative flex flex-col flex-shrink-0 ${isOpen ? 'w-64' : 'w-[68px]'}`}
            >
                {/* Top Header Actions */}
