...
export default function Sidebar({
    ...
    return (
        <>
            <div
                className={`bg-gray-50 dark:bg-[#02060D] border-r border-gray-200 dark:border-white/5 h-full transition-[width] duration-300 ease-in-out relative flex flex-col flex-shrink-0 ${isOpen ? 'w-64' : 'w-[68px]'}`}
            >
                {/* Top Header Actions */}
