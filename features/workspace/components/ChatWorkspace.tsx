...
export default function ChatWorkspace() {
    ...
    return (
        <div className="flex-1 flex overflow-hidden relative h-full bg-[#f8fafc] dark:bg-[#02060D] text-gray-900 dark:text-white font-sans z-0 transition-colors duration-300">
