                        ...
                        <div className="relative group">
                            ...
                            {isAgentOpen && (
                                <>
                                    ...
                                    <div className="absolute top-full left-0 mt-2 w-48 bg-[#ecfeff] dark:bg-[#1e1e1e] rounded-2xl shadow-xl dark:shadow-2xl border border-cyan-200 dark:border-white/[0.07] z-50 flex flex-col p-1.5 animate-in fade-in slide-in-from-top-2 zoom-in-95">
                                        {AGENTS.map((agent) => (
                                            <button
                                                key={agent.id}
                                                onClick={() => {
