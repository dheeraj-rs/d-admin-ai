...
const HomeView = () => {
  ...
  return (
    <div className="flex-1 w-full min-h-[100dvh] bg-[#f8fafc] dark:bg-[#02060D] text-gray-900 dark:text-white font-sans overflow-y-auto overflow-x-hidden relative z-0 flex flex-col custom-scrollbar transition-colors duration-300">
        ...
        <div className="absolute inset-x-0 top-0 h-[25%] bg-gradient-to-b from-[#f8fafc] via-[#f8fafc]/80 dark:from-[#02060D]/60 dark:via-transparent to-transparent transition-colors duration-300 pointer-events-none" />
        <div className="absolute inset-y-0 left-0 w-[50%] md:w-[40%] bg-gradient-to-r from-[#f8fafc] via-[#f8fafc]/90 dark:from-[#02060D] dark:via-transparent to-transparent transition-colors duration-300 pointer-events-none" />
        <div className="absolute inset-y-0 right-0 w-[40%] md:w-[35%] bg-gradient-to-l from-[#f8fafc] via-[#f8fafc]/80 dark:from-[#02060D]/80 dark:via-transparent to-transparent transition-colors duration-300 pointer-events-none" />
      </div>
